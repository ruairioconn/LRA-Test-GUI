...
sensor_list = {'PT and LC': {0: ['Thrust', 'ai0', 'LC5', 'lbf']}}
...
PTLC_time = []
PTLC_titles = []
PTLC_file = TdmsFile("COTS_lbs.xlsx")
for key in sensor_list['PT and LC']:
    PTLC_titles.append(sensor_list['PT and LC'][key][0])
    data = pd.ExcelFile('COTS_lbs.xlsx')
    df1 = data.parse('_unnamedTask<1>')
    PTLC_data = df1['Lbs']
